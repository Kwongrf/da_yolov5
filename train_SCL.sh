...
# python train_SCL.py --hyp hyp.scratch.yaml  --data cityscape2foggy.yaml --cfg yolov5m.yaml --weights "runs/train/scl_v5m300e4/weights/last.pt"  --batch-size 8 --device 2 --img-size 640 --epochs 100 --name inst_align_v5m300e_9da --da 9
python train_SCL.py --hyp hyp.scratch.yaml  --data cityscape2foggy.yaml --cfg yolov5m.yaml --weights "yolov5m.pt"  --batch-size 8 --device 3  --img-size 640 --epochs 300 --name debug --da 9
