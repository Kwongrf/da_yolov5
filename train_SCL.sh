...
python train_SCL.py --data cityscape2foggy.yaml --cfg yolov5m.yaml --weights "runs/train/scl_v5m300e4/weights/best.pt" --batch-size 8 --device 2 --img-size 640 --epochs 500 --name debug --da 9 
